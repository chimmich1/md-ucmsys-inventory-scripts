...
Current work: **PR-08, 1.0.0 release promotion planning**.
Branch: `plan/pr08-release-promotion`. PR-01 through PR-07 are merged; PR-07
implementation merged as GitHub PR 9.
PR-04 merged as
...
Next action: review and merge the PR-08 plan in
`docs/PR-08-RELEASE-PROMOTION-PLAN.md`, then implement the version and release
documentation changes. No live collection is required.
...
| **PR-08** | Promote the accepted collector to 1.0.0 and close the roadmap; no collection behavior changes. | Current-main tests and migrated-state read-only Validate pass; version and release documentation align; no provider calls or runtime migration. | Planning |
